...
jb.getViewSize = function() {
  var size = {width: jb.canvas.width, height: jb.canvas.height};
  return size;
};
...
jb.getWindowSize = function() {var win = window,
  doc = document,
...
jb.GESTURE = {NONE: 0, BUSY: 1, TAP: 2, HOLD: 3, TAP_HOLD: 4, DOUBLE_TAP: 5};
...
jb.addTouchButton = function(id, left, top, width, height) {
  jb.touchButtons.push({id: id, dt: 0, bounds: new jb.bounds(left, top, width, height), isDown: false, downTime: 0, upTime: 0, tapCount: 0, gesture: jb.GESTURE.NONE, touchId: -1})
},
